...
int main(int argc, char* argv[]){
  ...
  cout << "Press any key to continue..." << endl;
  getchar();
  moveRobotByJointChange("0.15 0 0 1.51 0 0 0", 1, -0.3, incremental);
  moveRobotByJointChange("0.15 -0.3 0 1.51 0 0 0", 3, 2.11, incremental);
  moveRobotByJointRange("0.15 -0.3 0 2.11 0 0 0", 0, -1.53, 0.6, incremental);
  cout<<"move sequence 2"<<endl;
  //cout << "Press any key to continue..." << endl;
  //getchar();
  //moveRobotByJointChange("0.15 -0.3 0 2.11 0 0 0", 3, 2.4, incremental);
  //now comes to our workspace
  // cout<<"move sequence 3"<<endl;
  // cout << "Press any key to continue..." << endl;
  // getchar();
  // moveRobotByJointChange("0.15 0 0 2.4 0 0 0", 0, 0, incremental);
  cout<<"move sequence 4"<<endl;
  //moveRobotByJointRange("0 0 0 2.4 0 0 0", 2, -1, 0.5, incremental);
  moveRobot("0.15 -0.3 0 2.11 0 0 0");
  moveRobotByJointChange("0.15 -0.3 0 2.11 0 0 0", 2, 0.7, incremental);
  cout<<"move sequence 5"<<endl;
  moveRobotByJointChange("0.15 -0.3 0.7 2.4 0 0 0", 3, 2.11, incremental);
  cout<<"move sequence 6 "<<endl;
  moveRobotByJointChange("0.15 -0.3 0 2.11 0 0 0", 0, 0, incremental);
  cout<<"move sequence 7 "<<endl;
  pressKey2Continue(1);
  moveRobotByJointChange("0 -0.3 0 2.11 0 0 0", 0, -1.52, incremental);
  pressKey2Continue(2);
  moveRobotByJointChange("-1.52 0 0 2.11 0 0 0", 0, -1.20, incremental);
  pressKey2Continue(3);
  moveRobotByJointChange("-1.20 0 0 2.11 0 0 0", 1, -0.43, incremental);
  pressKey2Continue(4);
  moveRobotByJointChange("-1.20 -0.43 0 2.11 0 0 0", 1, 0.45, incremental);
  pressKey2Continue(5);
  moveRobotByJointChange("-1.20 0.45 0 2.11 0 0 0", 1, 0, incremental);
  pressKey2Continue(6);
  moveRobotByJointChange("-1.20 0 0 2.11 0 0 0", 2, -0.39, incremental);
  pressKey2Continue(7);
  moveRobotByJointChange("-1.20 0 -0.39 2.11 0 0 0", 2, -0.15, incremental);
  pressKey2Continue(8);
  moveRobotByJointChange("-1.2 0 -0.15 2.11 0 0 0", 0, 0, incremental);
  pressKey2Continue(9);
  moveRobotByJointChange("0 0 -0.15 2.11 0 0 0", 2, 0, incremental);

  moveRobotByJointChange("0 0 0 2.11 0 0 0", 3, 1.9, incremental);
  moveRobotByJointChange("0 0 0 1.9 0 0 0", 1, 0.5, incremental);
