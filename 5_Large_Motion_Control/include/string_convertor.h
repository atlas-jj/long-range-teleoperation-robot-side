...
class string_convertor
{
    public:
       ...
       static void printOutStdVector_f(std::vector<float> v);
       ...
       static std::vector<double> split2double(const std::string &s, char delim);
       static void printStrArray(string *strs);
       static std::vector<std::string>  safeRemoveStringVec(std::vector<std::string> input, int removeIndex);
};
